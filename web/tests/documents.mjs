...
//
// Chosen to cover PLAN.md 3's inference rules and 4's enforcement, not to
// flatter the format: five of them are shapes colbin does badly on or refuses.
...
export const documents = [
  ...
  },
  {
    ...
    // PLAN.md 6's dense-column property, made visible: the third record comes
